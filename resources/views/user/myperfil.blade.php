            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body px-4">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8 text-capitalize">{{ $user->level }}</dd>

                        <dt class="col-sm-4">CPF</dt>
                        <dd class="col-sm-8">{{ $user->cpf }}</dd>
        ...
        <div class="col-md-10 col-lg-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-secondary text-white">
                    <h5 class="mb-0"><i class="bi bi-folder2-open me-2"></i>Meus Projetos</h5>
                </div>
                <div class="card-body px-4">
                        ...
                        @foreach($user->posts as $projeto)
                            <li class="list-group-item">
                                <div class="d-flex justify-content-between align-items-start">
                                    ...
                                    <a href="{{ route('edit.project',$projeto->id) }}" class="btn btn-sm btn-outline-primary">Editar</a>
                                </div>
                            </li>
                        @endforeach
                    </ul>
